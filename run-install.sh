...
create_venv() {
    ...
    python -m pip install torch==2.7.1 torchvision==0.22.1 torchaudio==2.7.1 --upgrade --index-url https://download.pytorch.org/whl/cu128
...
finish() {
    ...
    clear
    echo "Codename-RVC-Fork has been successfully installed. Run the file run-fork.sh to start the web interface!"
    exit 0
}
